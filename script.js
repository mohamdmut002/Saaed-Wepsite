const dict = {
  ar: {
    ...
    hero_title:'ساحات الحجز المرورية | ساعد للأنظمة المرورية',
    hero_sub:'كل ما تحتاجه في مكان واحد: القوانين والأوراق المطلوبة لاستلام مركبتك، بالإضافة إلى مواقع جميع الساحات التابعة لنا.',
    ...
    laws: [
      ...
      {t:'خلال الشهر الأول من دخول المركبة الساحة: تُحتسب غرامة يومية قدرها 100 درهم (رسوم الساحة)، بالإضافة إلى رسوم ريكفري لمرة واحدة قدرها 500 درهم. وبعد مرور 30 يومًا، تتحول الغرامة من الاحتساب اليومي إلى مبلغ ثابت قدره 500 درهم شهريًا.', key:true},
  ...
  en: {
    ...
    laws: [
      ...
      {t:'During the first month after the vehicle enters the yard: a daily yard fee of AED 100 applies, plus a one-time recovery fee of AED 500. After 30 days, the fee switches from a daily charge to a flat AED 500 per month.', key:true},
  ...
  ur: {
    ...
    laws: [
      ...
      {t:'گاڑی یارڈ میں آنے کے پہلے مہینے کے دوران: روزانہ 100 درہم یارڈ فیس لاگو ہوتی ہے، اور ایک بار 500 درہم ریکوری فیس بھی۔ 30 دن کے بعد یہ روزانہ فیس کی بجائے ماہانہ 500 درہم مقرر ہو جاتی ہے۔', key:true},
